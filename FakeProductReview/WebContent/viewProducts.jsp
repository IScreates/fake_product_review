										...
										<li class="span3">
											...
											<div class="thumbnail">
												<div class="caption cntr">
													...
													<p>
														<img alt="" src="Images/r.jpg" style="width: 15%"><strong><i class="fa fa-inr" style="font-size:14px">&nbsp;<%=rs.getString("base_price")%></strong>
													</p>
													<p><%=rs.getString("specification")%></p><br>
													<!-- <hr /> -->
													<h4>
														<a class="shopBtn"
