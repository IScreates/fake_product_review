...
%>
			...
			<div class="span12">
				...
				<div class="well well-small">
					...
					<tr>
						...
						<a href="paymentProcess.jsp?email=<%=email%>"><b class="shopBtn"><u>Online Payment</u></b></a></td><br></br>
					</tr>
					<tr>
						<td><a href="Feedback.jsp"><b class="shopBtn"><u>Feedback</u></b></a></td>
					</tr>
					<br>
					<br /> <br />
					</form>
	...
	<div class="copyright">
		<div class="container">
			...
			<span>Copyright &copy; Bootstrap Online E-Commerce Shopping	System Template.
			</span>
		</div>
	</div>
